...
빌드는 약 30초 정도 걸립니다. Ribbind은 메뉴바에서 동작하며 Dock 아이콘은 표시되지 않습니다.

**3단계. 권한 부여.** 첫 실행 시 Accessibility 권한을 한 번 요청합니다. Word, PowerPoint, Chrome에서 단축키를 처음 사용할 때마다 Automation 권한도 한 번씩 묻습니다. 모두 시스템 다이얼로그에서 한 번 클릭하면 됩니다.
...
*Crop* 과 *Lock Aspect Ratio* 옆 ⚠ 표시는 이미지가 선택된 상태여야 동작한다는 뜻입니다.
...
업데이트 후에는 Accessibility 권한을 다시 부여해야 할 수 있습니다.
