...
// #Preview blocks removed for Command-Line-Tools compatibility (PreviewsMacros plugin
// is only bundled with full Xcode). Re-add via the upstream repo if needed.
#endif
